...
const MortgageCalc = () => {
    ...
    return (
        <GlassCard className="h-full flex flex-col">
            ...
            <button onClick={calculate} className="w-full bg-blue-500/20 border border-blue-500 text-blue-400 py-2 rounded hover:bg-blue-500 hover:text-black font-bold mb-4 touch-manipulation cursor-pointer">Calculate</button>
...
const ROICalc = () => {
    ...
    return (
        <GlassCard className="h-full flex flex-col">
            ...
            <button onClick={calculate} className="w-full bg-green-500/20 border border-green-500 text-green-400 py-2 rounded hover:bg-green-500 hover:text-black font-bold mb-4 touch-manipulation cursor-pointer">Calculate ROI</button>
            <div className="text-center p-4 bg-white/5 rounded border border-white/10">
