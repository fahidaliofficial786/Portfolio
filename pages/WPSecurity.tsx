  ...
  return (
    <div className="pt-24 pb-12">
      ...
      <section className="container mx-auto max-w-5xl px-4 text-center mb-20">
        <div className="inline-block p-3 rounded-full bg-red-500/10 text-red-500 mb-6 border border-red-500/20 animate-pulse">
      ...
      <section className="container mx-auto max-w-6xl px-4 mb-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <GlassCard key={i} className="text-center p-6 border-red-500/20">
      ...
      <section className="container mx-auto max-w-6xl px-4 mb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-1 w-full">
                  ...
                  <GlassCard className="p-2 overflow-hidden rounded-xl h-[600px]">
              ...
              <div className="lg:col-span-2 w-full">
                  ...
                  <GlassCard className="p-2 overflow-hidden h-[600px] rounded-xl bg-white">
